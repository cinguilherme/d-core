(ns d-core.core.codecs.protocol
  (:require [integrant.core :as ig]))

(defprotocol Codec
  (encode [codec value] "Encode a Clojure value into a transport representation (string/bytes).")
...
(defmethod ig/init-key :d-core.core.codecs/codec
  [_ {:keys [codecs codec]
      :or {codecs nil}}]
  ;; Accept either:
