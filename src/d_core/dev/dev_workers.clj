(ns d-core.dev.dev-workers
  (:require [clojure.core.async :as async]
            ...
            [d-core.libs.workers :as workers :refer [command! request! stats-snapshot]])
...
(defn image-download-worker
  [ctx {:keys [image-url max-bytes resize reply-chan]}]
  (let [bytes (download-bytes image-url)]
